                ...
                <div class="card-body pt-3">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview" aria-selected="true" role="tab">Detalhes do Perfil</button>
                        </li>
                    </ul>
                    <div class="tab-content pt-4">
                        <div class="tab-pane fade profile-overview active show" id="profile-overview" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">{{\Auth::user()->position->name ?? 'Sem posição'}}</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Altura</div>
                                <div class="col-lg-9 col-md-8">{{\Auth::user()->height ?? 'Sem altura'}}</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Peso</div>
                                <div class="col-lg-9 col-md-8">{{\Auth::user()->weight ?? 'Sem peso'}}</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Telefone</div>
                                <div class="col-lg-9 col-md-8">{{\Auth::user()->phone ?? 'Sem telefone'}}</div>
                            </div>

  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link " href="{{route('admin.teams.index')}}">
        ...
        <span> @if(\Auth::user()->hasRole('Administrador')) Equipes @elseif(\Auth::user()->hasRole('Treinador')) Minha equipe @endif</span>
      </a>
    </li>
    @endcan
    ...
    <li class="nav-item">
      <a class="nav-link " href="{{route('admin.menstrualcalendars.index')}}">
        ...
        <span>Calendário menstrual</span>
      </a>
    </li>
    @endcan
...
<footer id="footer" class="footer">
  <div class="copyright">
    &copy; Copyright <strong><span>PerformanceMax</span></strong>. Todos os direitos reservados
  </div>
  <div class="credits">

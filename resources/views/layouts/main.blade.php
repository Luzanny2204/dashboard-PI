        ...
        <li class="nav-item">
            ...
            <i class="bi bi-journal-text"></i><span>Formularios</span><i class="bi bi-chevron-down ms-auto"></i>
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a  href="{{ route('formulario.atleta') }}">
                        <i class="bi bi-circle"></i><span> Atleta-Infomação Geral</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('formulario.biologico') }}">
                        <i class="bi bi-circle"></i><span>Dados Biologicos</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('formulario.mestruacion') }}">
                        <i class="bi bi-circle"></i><span>Menstruação</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('formulario.fadiga') }}">
                        <i class="bi bi-circle"></i><span>Fadiga</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('formulario.pse') }}">
                        <i class="bi bi-circle"></i><span>PSE</span>
                        </a>
                    </li>
                </ul>
        </li>
